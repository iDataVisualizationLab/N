(function () {
    ...
    var scagnostics = createCommonjsModule(function (module, exports) {
        (function () {
            /**
            ...
            var root = typeof self == 'object' && self.self === self && self ||
                ...
                this ||
                {};
            root.scagnostics = function (inputPoints, options = {}) {
                ...
                return root.scagnostics;

                function outputValue(name, value) {
                    root.scagnostics[name] = value;
                }
            };
