let ulti = function() {
    ...
    ulti.drawColorLegend = ()=>{
        ...
        svg.append("text")
            ...
            .attr("x", xx - 6)
            .attr("y", y4 + 20)
            .text(numberInputTerms + " terms of " + dataLength + " blogs")
            .attr("dy", ".21em")
            .attr("font-family", "sans-serif")
            .attr("font-size", "11px")
            .style("text-anchor", "left")
    ...
    ulti.drawTimeLegend = () => {
        ...
        svg.selectAll(".timeLegendText").data(listX)
            ...
            .attr("y", function (d, i) {
                if (i % 12 == 0)
                    return graphicopt.height - 7;
                else
                    return graphicopt.height - 15;
            })
            .attr("dy", ".21em")
            .attr("font-family", "sans-serif")
            .attr("font-size", "12px")
    ...
    ulti.updateTimeBox = (durationTime) => {
        var maxY = 0;
...
// Toggle children on click.
    ...
    ulti.svg = function (_) {
        return arguments.length ? (svg = _, ulti) : svg;
    };
    ...
    ulti.dataLength = function (_) {
        return arguments.length ? (dataLength = _, ulti) : dataLength;
    };

    ulti.numberInputTerms = function (_) {
        return arguments.length ? (numberInputTerms = _, ulti) : numberInputTerms;
    };

    ulti.xStep = function (_) {
        return arguments.length ? (xStep = _, ulti) : xStep;
    };

    ulti.xScale = function (_) {
        return arguments.length ? (xScale = _, ulti) : xScale;
    };
