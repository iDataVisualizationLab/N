...
var sidenav;
let self = null;
var categoriesgroup ={"COVID-19":["COVID-19",'Virus'],"Organization":["Organization"],"Nation":["Nation"],"Location":["Location"],"Other":["Other"]};
// var color = d3.scaleOrdinal(d3.schemeCategory10);
var color = (k)=>{
    // const colorL = {"COVID-19":"#d62728","Organization":"#2ca02c","Nation":"#1f77b4","Location":"#9467bd","Other":"#aeaeae"};
    const colorL = ["#d62728", "#2ca02c", "#1f77b4", "#9467bd", "#aeaeae"];
    return colorL[k];
};
var categories=[];
...
// Get the offset position of the navbar
    ...
    d3.queue()
        .defer(d3.json,"src/data/covid19_inTime.json")
        .await(ready);
...
let nonsenseCharacter = new RegExp(/\)|\(|&|\/|~|=|≥|[0-9]-[0-9]/gi);
